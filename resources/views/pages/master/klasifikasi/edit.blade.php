        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="">
                        <h4>Group : edit</h4>
                        <p class="f-m-light mt-1">Page for edit Master Group</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('master.klasifikasi.update', $klasifikasi) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select id="group_code" name="group_code"
                                ...
                                @foreach ($groups as $group)
                                    <option value="{{ $group->code }}" @if ($klasifikasi->group_code === $group->code) selected @endif>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="name" type="text" name="name"
                                class="form-control @error('name') is-invalid @enderror" value="{{ $klasifikasi->name }}">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <select id="transaction_type" name="transaction_type"
                                ...
                                <option value="DEBIT" @if ($klasifikasi->transaction_type === 'DEBIT') selected @endif>DEBIT</option>
                                <option value="KREDIT" @if ($klasifikasi->transaction_type === 'KREDIT') selected @endif>KREDIT</option>
                            </select>
