        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="">
                        <h4>Subklasifikasi</h4>
                        <p class="f-m-light mt-1">Page for create Master Subklasifikasi</p>
                    </div>
                    <div class="">
                        <a href="{{ route('master.sub-klasifikasi.create') }}">
...
@section('js')
    <script>
        $("#basic-1").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('datatable.master.sub-klasifikasi') }}",
                type: 'GET',
            },
            columns: [{
                    data: 'code',
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        let url = "{{ route('master.sub-klasifikasi.edit', ':id') }}";
                        url = url.replace(':id', data);

                        let deleteUrl = "{{ route('master.sub-klasifikasi.destroy', ':id') }}";
