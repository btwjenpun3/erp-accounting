                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="d-flex">
                                            <div class="media-left"><img class="media-object img-60 for-light"
                                                    src="../assets/images/other-images/logo-login.png" alt=""><img
                                                    class="media-object img-60 for-dark"
                                                    src="../assets/images/other-images/logo-light.png" alt=""></div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="text-md-end text-xs-center">
                                            ...
                                            <p>Issued: May<span> 27, 2024</span><br> Payment Due: June <span>27, 2024</span>
                                            </p>
                                        </div>
                                        <!-- End Title-->
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="text-md-end" id="project">
                                        ...
                                        <p>You're Only As Good As Your Last Collection, Which Is An Enormous Pressure. Jeans
                                            Represent Democracy In Fashion.Fashion Is About Dressing According To What's
                                            Fashionable.</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p class="m-0">Wild West - Red Cotton Blend Regular Fit Men's Formal
                                                        Shirt.</p>
                                                </td>
                                                <td>
